...
import com.android.Blood_Bank_App.Rakht_Spot.viewmodels.GetNearbyPlacesData;
...
public class NearByHospitalActivity extends Fragment implements
    ...
    protected synchronized void buildGoogleApiClient() {
        client = new GoogleApiClient.Builder(requireActivity().getApplicationContext()).addConnectionCallbacks(this).addOnConnectionFailedListener(this).addApi(LocationServices.API).build();
        client.connect();
